...
<head>
    ...
    <title>LiveWise - Smart Product Scanner & Health Analyzer</title>
    <meta name="description" content="Scan product barcodes, analyze ingredients, get health scores, and make informed purchasing decisions with LiveWise.">
    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        <div class="flex justify-between items-center h-16 md:h-18">
            ...
            <div class="flex items-center space-x-2.5">
                ...
                <span class="text-xl font-extrabold tracking-tight text-gray-900">LiveWise</span>
            </div>
        ...
        <div class="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
                ...
                <p class="text-lg text-gray-600 mb-8 leading-relaxed max-w-lg">
                    Instantly analyze product ingredients, get comprehensive health scores, and make informed purchasing decisions with LiveWise's advanced scanning technology.
                </p>
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-white p-5 flex flex-col items-center">
                        <div class="w-full bg-gray-900 rounded-3xl overflow-hidden shadow-xl">
                            <div class="bg-[#1FA774] px-4 py-3 flex items-center space-x-2">
                                ...
                                <div class="w-3 h-3 rounded-full bg-white/30"></div>
                                <div class="w-3 h-3 rounded-full bg-white/30"></div>
                                <span class="text-white text-xs font-mono ml-2">LiveWise Scanner</span>
                            </div>
...
<section id="how-it-works" class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        <div class="text-center mb-16"><h2 class="text-3xl md:text-4xl font-extrabold text-gray-900">How LiveWise Works</h2><p class="text-lg text-gray-600 max-w-2xl mx-auto mt-3">Get started in three simple steps and start making healthier choices today</p></div>
...
<section id="testimonials" class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-gray-50 rounded-2xl p-7 shadow-sm"><div class="flex text-[#1FA774] mb-4">★★★★★</div><p class="text-gray-700 mb-5 leading-relaxed">"LiveWise has completely changed how I shop for groceries. I can now easily identify products with harmful ingredients and make healthier choices for my family."</p><div class="flex items-center"><div class="w-10 h-10 rounded-full bg-[#1FA774]/20 flex items-center justify-center font-bold text-[#1FA774]">JD</div><div class="ml-3"><p class="font-bold text-gray-900">John Doe</p><p class="text-sm text-gray-500">Health Enthusiast</p></div></div></div>
